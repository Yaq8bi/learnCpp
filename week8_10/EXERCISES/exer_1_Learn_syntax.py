...
#3
print(1, "This is a String", 3.2, True, False)
...
#6
ment_stepped_on_the_moon = 8
print(ment_stepped_on_the_moon)
#7
...
gift_list = ["Socks", "Parfume", "Candles"]
print(gift_list)
...
grocery_items = {
    "Sweets": "Donuts" "Monks",
    "Veggies": "Brocolli" "Mushroom" "Tomatoes"
}
print(grocery_items)
...
bucket_list = ("Go to Japan", "Drink Matcha Tea", "Go to Malaysia", "Try Sambal")
print(bucket_list)
...
a = 10
b = 2*5
answer = "Even" if a is b  else "Odd"
print(answer)
...
a = True
b = (10 == 2*5)
answer = "True" if a and b is True else "False"
print(answer)
