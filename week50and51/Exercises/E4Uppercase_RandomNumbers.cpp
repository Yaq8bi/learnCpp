...
int main(){
    ...
    for (char &c : input){ // Soufien bana baskalarini dinleme, sen bunda iyisin: Ona for each loopun harika oldugunu soylemistim, ama arkadaslarim bu iyi degil dedi. bende embedded'ta hic mi kullanilmaz diye sordum.;
        c = toupper(c);
    }
